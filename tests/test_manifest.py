...
def test_manifest_finish_args() -> None:
    errors = {
        ...
        "finish-args-flatpak-system-folder-rw-access",
        "finish-args-flatpak-system-folder-foo-rw-access",
...
def test_manifest_modules_git_disallowed() -> None:
    ...
    errors = {
        ...
        "module-module6-source-git-file-branch",
        "module-module7-source-git-file-branch",
    }
    found_errors = set(ret["errors"])
    for e in errors:
